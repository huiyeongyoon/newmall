...
<header id="header">
  ...
  <nav class="navbar-shopping-list">
    ...
    <div class="list-wrapper">
      <ul>
        <li><a id="active" href="javascript:void(0);">Home</a></li>
        <li><a href="http://localhost:3000/product/">Product</a></li>
        <li><a href="http://localhost:3000/productdetail/">Product Detail</a></li>
  ...
  <div class="main-wrapper">
    ...
    <span class="main-picture-wrapper">
      ...
      <span class="sail-text-wrapper">
        ...
        <span class="bottom-text">Best Cloth Collection By 2021</span>
        <button>쇼핑하기</button>
      </span>
    </span>
...
<footer>
  <div class="footer-wrapper">
    <div class="footer-flex footer-font">
